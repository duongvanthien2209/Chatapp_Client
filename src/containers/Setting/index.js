...
import { Container, Row, Col, Nav, NavItem, NavLink, Form, FormGroup, Input, Label, Button, FormText } from 'reactstrap';
...
const Setting = () => {
    ...
    let updateShema = Yup.object().shape({
        name: Yup.string()
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            // console.log(user);
            userApi.update(formData, user._id).then(res => {
                debugger;
                ...
                <Row className="flex-grow-1">
                    <Col md="4" className="d-none d-md-block">
                        <Nav vertical className="h-100 border setting-navbar">
                            <NavItem>
                                <NavLink className="border-bottom" href="#">Cập nhật thông tin</NavLink>
                            </NavItem>
                        </Nav>
                    </Col>
                    <Col sm="12" md="8">
                        <div className="setting-personInformation border">
                            ...
                            <Form className="p-5 flex-grow-1" onSubmit={formik.handleSubmit}>
                                <FormGroup className="row mb-3">
                                    <Label for="name" className="col-sm-2 col-form-label">Tên</Label>
                                    <div className="col-sm-10">
                                        ...
                                        />
                                        <FormText color="danger">{formik.touched.name && formik.errors.name}</FormText>
                                    </div>
                                </FormGroup>
                                <FormGroup className="row mb-3">
                                ...
                                <FormGroup className="row mb-3">
                                    <Label for="password" className="col-sm-2 col-form-label">Mật khẩu</Label>
                                    <div className="col-sm-10">
                                        <Input
                                            type="password"
                                            id="password"
                                ...
                                <FormGroup className="row mb-3">
                                    <Label for="avatar" className="col-sm-2 col-form-label">Ảnh đại diện</Label>
                                    <div className="col-sm-10">
                                        <Input
                                            type="file"
                                            id="avatar"
                                ...
                                <FormGroup className="row">
                                    <div className="col-sm-10 offset-sm-2">
                                        <Button className="mr-2" type="reset" color="danger">Reset</Button>
